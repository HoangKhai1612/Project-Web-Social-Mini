...
const runCleanup = async () => {
    ...
    try {
        ...
        const tasks = [
            {
                name: 'archived_posts',
                query: 'DELETE FROM archived_posts WHERE archived_at < DATE_SUB(NOW(), INTERVAL 30 DAY)'
            },
            {
            ...
            },
            {
                ...
                query: "DELETE FROM reports WHERE status = 'dismissed' AND created_at < DATE_SUB(NOW(), INTERVAL 30 DAY)"
            },
            {
